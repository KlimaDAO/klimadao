...
import styles from "./InvalidRPCModal.module.css";
import t from "../styles/typography.module.css";

export const InvalidRPCModal = ({ onHide }) => {
  return (
    <>
      <div className={styles.bg}>
        <div className={styles.card}>
          <div className={styles.card_header}>
            ...
            <p className={t.body2}>
              The network could not be reached. This is most likely caused by an old Polygon RPC configuration in your
              wallet. See{" "}
              <a
                target="_blank"
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://discord.gg/klimadao">
                Discord
              </a>{" "}
              if problems persist.
            </p>
