...
//   async function (
//     { params }: FastifyRequest<{ Params: Params }>,
//     reply: FastifyReply
//   ) {
//     const { key, vintage: vintageStr } = deconstructListingId(params.id);
...
//     /** */
//     if (offset) {
//       const poolProject: PoolProject & Partial<CarbonOffset> = {
//         ...offset,
//         isPoolProject: true,
//       };

//       carbonOffsets?.map(function (carbonProject) {
//         const [listingPrices, pricetypes] = calculateProjectPoolPrices(
//           carbonProject,
//           poolPrices
//         );
//       });
