...
export function loadOrCreateDailyBond(timestamp: BigInt, token: Token): DailyBond {
    ...
    if (dailyBond == null) {
        ...
        dailyBond.payout = new BigDecimal(new BigInt(0))
...
export function createDailyBondRecord(timestamp: BigInt, token: Token, payout: BigDecimal, value: BigDecimal): void {
