...
export class BCT_USDC__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class BCT_USDC__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class BCT_USDC extends ethereum.SmartContract {
  static bind(address: Address): BCT_USDC {
    return new BCT_USDC("BCT_USDC", address);
  }
  ...
  burn(to: Address): BCT_USDC__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new BCT_USDC__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<BCT_USDC__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new BCT_USDC__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): BCT_USDC__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new BCT_USDC__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<BCT_USDC__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BCT_USDC__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
