...
# second public anvil wallet
DUMMY_SERVER_WALLET = 0x70997970C51812dc3A010C7d01b50e0d17dc79C8
...
TCO2_HOLDER = 0x00000e2b6fe65400b3a96c5b13e833b99622875d
...
tco2:
	...
	cast send ${TCO2} --unlocked --from ${TCO2_HOLDER} "approve(address,uint256)(bool)" ${DIAMOND} 83582546026230943 --rpc-url http://localhost:8545

	cast send ${TCO2} --unlocked --from ${TCO2_HOLDER} "transfer(address,uint256)(bool)" ${ANVIL_PUBLIC_WALLET} 83582546026230943 --rpc-url http://localhost:8545
