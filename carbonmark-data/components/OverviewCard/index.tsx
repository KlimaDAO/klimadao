...
export default function OverviewCard<T>(props: {
  ...
  const [topOptionKey, setTopOptionKey] = useState<Key>(props.topOptions ? props.topOptions[0].value : "")
  ...
  return (
    <div className={styles.cardContainer}>
      <div className={styles.cardHeader}>
        <h2>{props.title}</h2>
        {props.topOptions && (
          <OptionsSwitcher options={props.topOptions} onSelectionChange={setTopOptionKey}></OptionsSwitcher>
        )}
        {props.detailUrl && (
