...
describe("GET /retirements/klima/:account_id/:retirement_index/provenance", () => {
  ...
  beforeEach(async () => {
    try {
      ...
      console.error(
        "/retirements/klima/[:account_id]/[:retirement_index]/provenance get.test.ts setup failed",
        e
      );
    }
  });
  test("Returns a retirement provenance from account id and retirement index", async () => {
    ...
    const response = await fastify.inject({
      method: "GET",
      url: `${DEV_URL}/retirements/klima/0x0a1g3hcbteay53hd9ee1q8e06b56e8cd6767z52a/1/provenance`,
    });
