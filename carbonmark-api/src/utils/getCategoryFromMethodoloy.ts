...
// @todo correct types and import from lib if possible
const getMap = () => {
  const methodologyToCategoryMap = new Map<string, any>();
...
export const getCategoryFromMethodology = (methodology: string): any => {
