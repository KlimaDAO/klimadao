...
export type GetCountriesQuery = {
  __typename?: "Query";
  countries: Array<{ __typename?: "Country"; id: string }>;
};
...
export type GetVintagesQuery = {
  __typename?: "Query";
  projects: Array<{ __typename?: "Project"; vintage: string }>;
};
...
export type GetPurchasesByIdQuery = {
  __typename?: "Query";
  purchases: Array<{
    __typename?: "Purchase";
    id: any;
...
export type GetUserByWalletQuery = {
  __typename?: "Query";
  users: Array<{
    __typename?: "User";
    listings?: Array<{
    ...
    activities?: Array<{
      ...
      seller: { __typename?: "User"; id: any };
      buyer?: { __typename?: "User"; id: any } | null;
    }> | null;
    purchases?: Array<{ __typename?: "Purchase"; id: any }> | null;
  }>;
};
...
export type GetProjectsByIdQuery = {
  __typename?: "Query";
  projects: Array<{
    __typename?: "Project";
    id: string;
...
export function getSdk(
  ...
  return {
    ...
    getVintages(
      variables?: GetVintagesQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetVintagesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetVintagesQuery>(GetVintagesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getVintages",
    ...
    getPurchasesById(
      variables?: GetPurchasesByIdQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetPurchasesByIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPurchasesByIdQuery>(
    ...
    getUserByWallet(
      variables?: GetUserByWalletQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetUserByWalletQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUserByWalletQuery>(
    ...
    findProjects(
      ...
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<FindProjectsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<FindProjectsQuery>(FindProjectsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "findProjects",
    ...
    getProjectsById(
      variables?: GetProjectsByIdQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetProjectsByIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProjectsByIdQuery>(
