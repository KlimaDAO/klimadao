...
console.debug({
  ...
  NEXT_PUBLIC_CLIENT_INFURA_ID: process.env.NEXT_PUBLIC_CLIENT_INFURA_ID,
  NEXT_PUBLIC_VERCEL_GIT_COMMIT_SHA:
    process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_SHA,
  NEXT_PUBLIC_USE_PREVIEW_CARBONMARK_API:
    process.env.NEXT_PUBLIC_USE_PREVIEW_CARBONMARK_API,
  NEXT_PUBLIC_CARBONMARK_API_URL: process.env.NEXT_PUBLIC_CARBONMARK_API_URL,
  API_BASE: config.urls.api[ENVIRONMENT],
  ENVIRONMENT,
});
