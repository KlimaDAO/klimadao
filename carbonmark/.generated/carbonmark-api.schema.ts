export default {
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            "schema": {
              "type": "string",
              "pattern": "^(VCS|PURO|ICR|GS)-\\d+-(19\\d{2}|20\\d{2})$"
            },
  ...
  "servers": [
    {
      "url": "https://v2.0.0-12.api.carbonmark.com"
    }
  ],
  "externalDocs": {
