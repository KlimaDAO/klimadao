...
export type CarbonCreditFragmentFragment = { __typename?: 'CarbonCredit', id: any, bridgeProtocol: BridgeProtocol, vintage: number, currentSupply: string, retired: string, crossChainSupply: string };
