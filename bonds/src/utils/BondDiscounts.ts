...
export function updateBondDiscounts(transaction: Transaction): void {
  ...
  if (transaction.blockNumber.gt(BigInt.fromString(constants.BCTBOND_V1_BLOCK))) {
    ...
    if (price_call.reverted === false && price_call.value.gt(BigInt.fromI32(0))) {
      ...
      log.debug('BCT Discount KLIMA price {}  Bond Price {}  Discount {}', [
        klimaRate.toString(),
        price_call.value.toString(),
        bd.bct_discount.toString(),
      ])
    }
  }
  ...
  if (transaction.blockNumber.gt(BigInt.fromString(constants.KLIMA_BCT_BOND_V1_BLOCK))) {
    ...
    if (price_call.reverted === false && price_call.value.gt(BigInt.fromI32(0))) {
      ...
      log.debug('KLIMA-BCT Discount KLIMA price {}  Bond Price {}  Discount {}', [
        klimaRate.toString(),
        price_call.value.toString(),
        bd.klimabct_discount.toString(),
      ])
    }
  }
  ...
  if (transaction.blockNumber.gt(BigInt.fromString(constants.BCT_USDC_BOND_V1_BLOCK))) {
    ...
    if (price_call.reverted === false && price_call.value.gt(BigInt.fromI32(0))) {
      ...
      log.debug('BCT-USDC Discount KLIMA price {}  Bond Price {}  Discount {}', [
        klimaRate.toString(),
        price_call.value.toString(),
        bd.bctusdc_discount.toString(),
      ])
    }
  }
  ...
  if (transaction.blockNumber.gt(BigInt.fromString(constants.MCO2BOND_V1_BLOCK))) {
    ...
    if (price_call.reverted === false && price_call.value.gt(BigInt.fromI32(0))) {
      ...
      log.debug('MCO2 Discount KLIMA price {}  Bond Price {}  Discount {}', [
        klimaRate.toString(),
        price_call.value.toString(),
        bd.mco2_discount.toString(),
      ])
    }
  }
  ...
  if (transaction.blockNumber.gt(BigInt.fromString(constants.KLIMA_MCO2_BOND_V1_BLOCK))) {
    ...
    if (price_call.reverted === false && price_call.value.gt(BigInt.fromI32(0))) {
      ...
      log.debug('KLIMA-MCO2 Discount KLIMA price {}  Bond Price {}  Discount {}', [
        klimaRate.toString(),
        price_call.value.toString(),
        bd.klimamco2_discount.toString(),
      ])
    }
  }
  ...
  if (transaction.blockNumber.gt(BigInt.fromString(constants.KLIMA_USDC_BOND_V1_BLOCK))) {
    ...
    if (price_call.reverted === false && price_call.value.gt(BigInt.fromI32(0))) {
      ...
      log.debug('KLIMA-USDC Discount KLIMA price {}  Bond Price {}  Discount {}', [
        klimaRate.toString(),
        price_call.value.toString(),
        bd.klimausdc_discount.toString(),
      ])
    }
  }
