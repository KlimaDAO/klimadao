...
export const RetireForm: FC<Props> = (props) => {
  ...
  const methods = useForm<FormValues>({
    mode: "onChange",
    defaultValues: {
      projectTokenAddress: props.listing.tokenAddress,
      paymentMethod: "fiat",
      ...inputValues,
    },
  });
  ...
  const handleFiat = async () => {
    ...
    const reqParams = {
      ...
      project_address: props.listing.tokenAddress,
      ///TODO: There is no pool token for a listing retirement
      retirement_token: 'bct' as PoolToken,
    };
    try {
  ...
  const onMakeRetirement = async () => {
    ...
    try {
      ...
      const receipt = await retireCarbonTransaction({
        provider,
        address,
        projectAddress: props.listing.tokenAddress,
        paymentMethod: inputValues.paymentMethod,
        isPoolDefault: false,
        maxAmountIn: costs,
        retirementToken: 'bct' as PoolToken,
      ...
      <TwoColLayout>
          ...
          <Card>
            ...
            <div className={styles.formContainer}>
              ...
              <RetireInputs
                ...
                price={{singleUnitPrice: props.listing.singleUnitPrice} as TokenPrice}
                listing={props.listing}
                address={address}
        ...
        <Col>
          <div className={styles.stickyContentWrapper}>
            <Card>
              <AssetDetails price={{singleUnitPrice: props.listing.singleUnitPrice} as TokenPrice} listing={props.listing} project={props.project} />
            </Card>
