  ...
  return (
    <div className={styles.stakeCard}>
      ...
      <div className={styles.dataContainer}>
        ...
        <div className="stake-price-data-row">
          <TextInfoTooltip content="Amount of KLIMA tokens already staked by you and receiving rebase rewards.">
        ...
        <div className="stake-price-data-row">
          <TextInfoTooltip content="Approximate time left before the next round of rebase rewards.">
        ...
        <div className="stake-price-data-row">
          <TextInfoTooltip content="Percentage increase in your staked KLIMA at the next rebase.">
        ...
        <div className="stake-price-data-row">
          <TextInfoTooltip
            content="Percentage increase in ('or Return on Investment') on your staked KLIMA after 
                         5 days, assuming the current reward rate stays the same over the 5 day period and 
        ...
        <div className="stake-price-data-row">
          <TextInfoTooltip
            content="Percentage increase in your staked KLIMA after 1 year ('Annual Percentage Yield'), 
                        assuming the current reward rate stays the same over the 1 year period and taking 
                        into account the effect of compounding. PLEASE NOTE THAT THE CURRENT REWARD RATE MAY CHANGE 
                        AND IS NOT GUARANTEED TO STAY THE SAME OVER THE 1 YEAR PERIOD."
          >
        ...
        <div className="stake-price-data-row">
          <TextInfoTooltip
            content="Amount of staked KLIMA you would have now if you had staked 1 KLIMA from protocol inception."
          >
