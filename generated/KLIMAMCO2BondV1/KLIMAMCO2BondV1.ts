...
export class KLIMAMCO2BondV1__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class KLIMAMCO2BondV1__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class KLIMAMCO2BondV1__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class KLIMAMCO2BondV1 extends ethereum.SmartContract {
  static bind(address: Address): KLIMAMCO2BondV1 {
    return new KLIMAMCO2BondV1("KLIMAMCO2BondV1", address);
  }
  ...
  adjustment(): KLIMAMCO2BondV1__adjustmentResult {
    ...
    return new KLIMAMCO2BondV1__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<KLIMAMCO2BondV1__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new KLIMAMCO2BondV1__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): KLIMAMCO2BondV1__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new KLIMAMCO2BondV1__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<KLIMAMCO2BondV1__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new KLIMAMCO2BondV1__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  terms(): KLIMAMCO2BondV1__termsResult {
    let result = super.call(
      "terms",
    ...
    return new KLIMAMCO2BondV1__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<KLIMAMCO2BondV1__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new KLIMAMCO2BondV1__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
