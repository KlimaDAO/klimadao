  ...
  return (
    <div className={styles.stakeCard}>
      ...
      <div className={styles.dataContainer}>
        ...
        <p style={{ textAlign: 'center', fontSize: "1.6rem" }}>There is a small bug affecting users who staked in the first 18 hours after launch. We have posted <a target="_blank" href="https://www.notion.so/klimadao/sKLIMA-Bugfix-Instructions-079caaa21f6742daac201781ef5759da">step-by-step instructions</a> to fix the issue.</p>
