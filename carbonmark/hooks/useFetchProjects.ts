import { getProjectsQueryOptions } from ".generated/carbonmark-api-sdk/hooks/useGetProjects";
import { GetProjectsQueryResponse } from ".generated/carbonmark-api-sdk/types/GetProjects";
...
type TData = GetProjectsQueryResponse;
...
export const useFetchProjects = () => {
  ...
  const projects = useSWR<TData, unknown, string | null>(`/projects`, {
    ...getProjectsQueryOptions<TData, unknown>(mappedParams, {}),
  });
