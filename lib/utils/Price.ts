...
export class PriceUtil {
    ...
    static getBCT_USDRate(): BigDecimal {
        return this.getUniV2Rate(Address.fromString(BCT_USDC_PAIR),
    ...
    static getKLIMA_BCTRate(): BigDecimal {
        return this.getUniV2Rate(Address.fromString(KLIMA_BCT_PAIR),
                            this.bctToken.getDecimals(),
    ...
    static getKLIMA_USDRate(): BigDecimal {
        return this.getUniV2Rate(Address.fromString(KLIMA_USDC_PAIR),
                            this.usdcToken.getDecimals(),
                            this.klimaToken.getDecimals(),
                            RATE_FOR_TOKEN.SECOND)
    }
    ...
    static getKLIMA_MCO2Rate(): BigDecimal {
        return this.getUniV2Rate(Address.fromString(KLIMA_MCO2_PAIR),
                            this.klimaToken.getDecimals(),
    ...
    static getMCO2_USDRate(): BigDecimal {
        return this.getUniV2Rate(Address.fromString(MCO2_USDC_PAIR),
                            this.usdcToken.getDecimals(),
                            this.mco2Token.getDecimals(),
                            RATE_FOR_TOKEN.SECOND)
    }
    ...
    static getKLIMA_UBORate(): BigDecimal {
        return this.getUniV2Rate(Address.fromString(KLIMA_UBO_PAIR),
    ...
    static getKLIMA_NBORate(): BigDecimal {
        return this.getUniV2Rate(Address.fromString(KLIMA_NBO_PAIR),
                            this.klimaToken.getDecimals(),
    ...
    static getNCT_USDRate(): BigDecimal {
        return this.getUniV2Rate(Address.fromString(NCT_USDC_PAIR),
                            this.usdcToken.getDecimals(),
