...
// organize-imports-ignore
import "../theme/variables.css"; // overrides for variables.css - must be imported after
// organize-imports-ignore
import "@klimadao/lib/theme/globals.css"; // depends on variables
// organize-imports-ignore
import "../theme/globals.css"; // carbonmark-data specific overrides for globals.css

// With the followings does not work?
//import "@klimadao/carbonmark-data/theme/variables.css"; // overrides for variables.css - must be imported after
//import "@klimadao/carbonmark-data/theme/globals.css"; // carbonmark-data specific overrides for globals.css
...
function MyApp({ Component, pageProps, router }: AppProps) {
  ...
  return (
    <>
      ...
      {/*
      FIXME: Do we implement google analytics in there?
      <Script
        id="google-analytics"
