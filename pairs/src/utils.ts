...
export function calculateCCO2AdjustedPrice(swapClose: BigDecimal): {
  ...
  return { adjustedPrice: adjustedPrice, adjustedPricePerTonne: adjustedPrice.div(BigDecimal.fromString('1000')) }
}
